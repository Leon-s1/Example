...
const originalRows = [
    createData('Ампилогов Михаил Александрович',"Слесарь по обслуживанию и ремонту оборудования участка № 4", '----', "8-909-707-5637", "ampilogov.1979@mail.ru", "----" ),
    createData('Бушманов Сергей Владимирович', "Электрослесарь (слесарь) дежурный и по ремонту оборудования", '----', "8-906-868-9247", "bushmanov_sv@sibtranss.ru ", "----"),
    ...
    createData('Хакимьянов Рим Айратович ', "Начальник участка № 4", "----", '8-960-920-8719\n' + '8-909-743-2298\n',
         "khakimyanov_ra@sibtranss.ru", "cid.dc724d513462f606"),
