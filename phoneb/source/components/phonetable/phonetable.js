...
class PhoneTable extends Component {
    ...
    componentDidMount() {
        if (_isEmpty(this.props.items)) this.props.itemsFetchAllv2();
    }
        ...
        return (
            <div>
                ...
                <Table style={styles.widthTable}>
                    ...
                    >
                        <TableRow>
                            <TableHeaderColumn style={styles.textLeftUppercase}>
                                Photo
                            </TableHeaderColumn>
                            <TableHeaderColumn
                                style={styles.textLeftUppercaseFixed}
                            >
                                Name
                            </TableHeaderColumn>
                            <TableHeaderColumn
                            ...
                            <TableHeaderColumn
                                style={styles.textLeftUppercaseFixedLast}
                            >
                                Email
                            </TableHeaderColumn>
                        </TableRow>
                    ...
                    <TableBody displayRowCheckbox={false} showRowHover={true}>
                        {this.props.items.map((item, index) => (
                            <TableRow key={index}>
                                <TableRowColumn style={styles.textLeft}>
                                    {" "}
                                    <Avatar src={item.pictureThumb} />
                                </TableRowColumn>
                                <TableRowColumn style={styles.widthFixed}>
                                    <Link
                                        to={"/user/" + item.sha1}
                                        className="underline"
                                    >
